...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _start = __webpack_require__(228);

	var _start2 = _interopRequireDefault(_start);

	var _terms = __webpack_require__(229);

	var _terms2 = _interopRequireDefault(_terms);

	var _help = __webpack_require__(230);
	...
	_reactDom2.default.render(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.Route, { path: 'home', component: _start2.default }),
			_react2.default.createElement(_reactRouter.Route, { path: 'termsandconditions/:article', component: _terms2.default }),
			_react2.default.createElement(_reactRouter.Route, { path: 'termsandconditions', component: _terms2.default }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _winner = __webpack_require__(224);

	var _winner2 = _interopRequireDefault(_winner);

	var _bets = __webpack_require__(225);
	...
	var Ruleta = function (_React$Component) {
		_inherits(Ruleta, _React$Component);

		function Ruleta(props) {
			_classCallCheck(this, Ruleta);

			var _this = _possibleConstructorReturn(this, (Ruleta.__proto__ || Object.getPrototypeOf(Ruleta)).call(this, props));
			...
			_this.addBet = _this.addBet.bind(_this);
			return _this;
		}

		_createClass(Ruleta, [{
			key: 'addBet',
			value: function addBet(e) {
			...
			key: 'changeLoginUser',
			value: function changeLoginUser(title) {
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_signin2.default, { loginChange: this.changeLoginUser.bind(this), login: this.state.userValue }),
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: 'home', activeClassName: 'activeLink' },
						'Home'
					),
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: 'termsandconditions', activeClassName: 'activeLink' },
						'Terms and Conditions'
					),
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: 'help', activeClassName: 'activeLink' },
						'Help'
					),
					this.props.children,
					...
					_react2.default.createElement(_bets2.default, { apuestas: this.state.betNumber, tiempoApuesta: this.state.betTime, winnerNumber: this.state.winnerNumber }),
					_react2.default.createElement(_winner2.default, { winnerIs: this.state.success })
				);
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Winner = function (_React$Component) {
		...
		function Winner() {
			...
			return _possibleConstructorReturn(this, (Winner.__proto__ || Object.getPrototypeOf(Winner)).apply(this, arguments));
		}
		...
		_createClass(Winner, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'span',
						{ className: this.props.winnerIs == null ? 'hidden' : '' },
						_react2.default.createElement(
							'h1',
							null,
							'Ganaste con los n\xFAmeros: ',
							getWinners
						)
					)
				);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Bets = function (_React$Component) {
		_inherits(Bets, _React$Component);

		function Bets() {
			_classCallCheck(this, Bets);

			return _possibleConstructorReturn(this, (Bets.__proto__ || Object.getPrototypeOf(Bets)).apply(this, arguments));
		}
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'h4',
						null,
						'La apuesta cierra en ',
						this.props.tiempoApuesta
					),
					_react2.default.createElement(
						'h1',
						{ className: this.props.winnerNumber == null ? 'hidden' : '' },
						'El n\xFAmero ganador es: ',
						this.props.winnerNumber
					)
				);
			}
		}]);
		...
		_createClass(SignIn, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this), ref: 'input' }),
					_react2.default.createElement(
						'button',
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'h5',
						null,
						this.props.location.query.tfefe
					)
				);
			}
		}]);
